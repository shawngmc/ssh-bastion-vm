...
- Alert on: successful root login (should never happen)
- Alert on: logins from new IPs
- Alert on: multiple fail2ban bans in a short window
- Alert on: each Fail2ban ban
