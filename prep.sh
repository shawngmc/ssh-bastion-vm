...
# 11. Set up Slug for VM type IDing
SLUG=$(jq .slug)
...
# 40. Stage the authorized_keys file
# Skipped - handled via cloud-init
...
# Email the TOTP key out of band
